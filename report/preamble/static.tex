...
\def\thesisauthor  {Eske Haack (s214643)}
\def\thesistitle   {Conditional Diffusion Models for Temperature and Precipitation Super-resolution over Europe}
\def\thesissubtitle{SIRIUS}
