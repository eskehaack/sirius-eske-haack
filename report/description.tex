...
\textbf{Danish title}: Betingede Diffusionsmodeller til temperatur- og nedbørsnedskalering over Europa \\
\textbf{English title}: Conditional Diffusion Models for Temperature- and precipitation-downscaling over Europe \\
...
\textbf{Project carryed out in}: Denmark \\
